...
ALLEGRO_BITMAP *nivel_jupiter = NULL;
ALLEGRO_BITMAP *transicao_jupiter = NULL;
ALLEGRO_BITMAP *botaoEnviar = NULL;
ALLEGRO_BITMAP *caixaDeTexto = NULL;
ALLEGRO_BITMAP *quadroPalavras = NULL;
